...
> `sh -c "$(curl -fsSL https://raw.githubusercontent.com/karlzeo/mac-cli/master/mac-cli/tools/update)"`
...
> `sh -c "$(curl -fsSL https://raw.githubusercontent.com/karlzeo/mac-cli/master/mac-cli/tools/uninstall)"`
